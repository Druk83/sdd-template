...
### 4. Верификация релевантности контексту
**Запрещено:**
...
**Правильно:**
- Брать термины из входных источников (`.source/`, документация)
- Примеры — из контекста текущего проекта
- При сомнении — спросить разработчика
...
- `docs/requirements/` - готовые документы технической документации
- `.tasks/` - текущие задачи и планирование
- `.issues/` - текущие проблемы и баги
- `.manifest/` - манифесты инструментов и процессов
- `README.md` - обзор проекта

**Пути к шаблонам по которым строится документация в docs/:**
...
- Читать `docs/requirements/` для фактов проекта
...
## Работа с SDD (техническая документация)

**ОБЯЗАТЕЛЬНО** читай `.manifest/sddmanifest.md` когда разработчик говорит о:
- Создании технической документации
- Работе с `.source/` или `.requirements/`
- Этапах документирования [1]-[9]
- Треке разработки

Коротко:
1. Принять системные правила
2. Изучить `.source/`, задать уточняющие вопросы
3. Следовать `.requirements/трек разработки.md` **пошагово**
4. Выполнять **один этап за раз**, останавливаться после каждого
5. Вести gap-tracking.md
