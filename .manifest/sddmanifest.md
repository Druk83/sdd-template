...
## sdd.H4.15 Структура файлов диаграмм
**Правила:**
...
## sdd.H4.16 Правила для агента (сводка)
**Агент ОБЯЗАН:**
...
## sdd.H4.17 Процедура обновления H0-файлов
...
## sdd.H4.18 Применение подходов из .approach/
...
## sdd.H4.19 Классификация GAP перед созданием записи
