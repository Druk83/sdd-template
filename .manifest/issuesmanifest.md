...
## 1) Фиксируй проблемы с трассировкой до закрытия
...
## 2) Создавай Issue при неясности, координации или исследовании
...
## 3) Указывай type для каждого Issue
...
## 4) Указывай priority и severity
...
## 5) Обновляй status по ходу работы
...
## 6) Заполняй минимальные обязательные поля
...
## 8) Следуй workflow: Triage → Task → PR → Close
...
## 12) Ориентируйся на примеры качества
