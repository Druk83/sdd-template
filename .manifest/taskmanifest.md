...
## 2) Где живут задачи и как называются
...
## 3) Обязательная структура файла задачи
...
## 5) Трассировка к требованиям/сценариям/стеку
...
## 7) Шаблон задачи (копируется в `.tasks/*.md`)
...
## 8) Мини-чек для ревью задачи (для людей/агентов)
