...
## 0. Термины и уровни README (критично)
...
## 1. Принцип Single Source of Truth (anti-duplication)
...
## 2. Алгоритм агента при запросах “опиши раздел/папку” (обязательный)
...
## 3. Граница ответственности: манифест vs README (чтобы не дублировать)
...
## 4. Требования к содержанию по уровням
...
## 5. Источник правды для команд/опций/ENV (чтобы агент не “выдумывал”)
...
## 7. Где живут “подробности” (чтобы не раздувать README)
...
## 9. Definition of Done (контроль качества)
