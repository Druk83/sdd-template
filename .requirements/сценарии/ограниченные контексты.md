...
- **Домен (domain_slug):** <domain_slug> <!-- берётся только из `docs/домены/реестр.md` -->
- **Дата обновления:** <YYYY-MM-DD>

- **Связанные документы (документы проекта):**
  - Domain Card: `docs/домены/<domain_slug>.md`
  - Process Map: `docs/сценарии/<domain_slug>/карта процесса.md`
  - Event Catalog: `docs/сценарии/<domain_slug>/каталог мероприятий.md`
...
## 2. Context Map (взаимоотношения контекстов)
...
### 2.1 Anti-Corruption Layer (ACL) (если есть)
...
## 3. Integration Matrix (Publish / Subscribe)
...
## 4. Контракты интеграции (ссылки и правила)
...
## 5. Команды и синхронные вызовы (опционально)
