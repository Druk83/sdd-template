...
> Заполненная карта процесса создаётся в: `docs/сценарии/<domain_slug>/карта процесса.md`,
> где `<domain_slug>` берётся из `docs/домены/реестр.md`.
...
- **Источник домена:** `docs/домены/<domain_slug>.md`
