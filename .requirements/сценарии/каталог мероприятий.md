...
> `docs/сценарии/<domain_slug>/каталог мероприятий.md` (write-only).
...
- **Связанные документы (формат):**
  - Карта процесса домена: `docs/сценарии/<domain_slug>/карта процесса.md`
  - Карточка домена: `docs/домены/<domain_slug>.md`
