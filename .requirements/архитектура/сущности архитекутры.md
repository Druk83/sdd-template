...
- Сценарии (результаты): `docs/сценарии/**`
...
10. `<DataObject1>` — владелец: `<BC/Component>` *(MUST/SHOULD/OPTIONAL)*  
    ...
    - Источники: `<docs/сценарии/**; требования>`
11. `<DataObject2>` — `<...>`
...
## BC List
- **BC-01 `<BCName>`:** `<responsibility>` — владельцы данных: `<entities>` — источники: `<docs/сценарии/**; docs/домены/**>`
- **BC-02 `<BCName>`:** `<...>`
