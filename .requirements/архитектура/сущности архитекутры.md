...
**Важно:** агент **НЕ придумывает** сущности; он извлекает их из стека/сценариев/требований. Если данных нет — фиксируй `Не определено` и создавай GAP в `docs/requirements/gap-tracking.md`.
