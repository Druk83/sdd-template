...
> **ОБЯЗАТЕЛЬНО:** Перед детальным описанием сценариев сформулируй перечень инфраструктурных компонентов и получи подтверждение разработчика.
...
1. Проанализируй `docs/requirements/архитектура/описание AL.md` (компоненты)
2. Проанализируй `docs/requirements/структура ПО/стек проекта.md` (инфраструктура)
3. Проанализируй NFR (availability, RTO/RPO, security)
