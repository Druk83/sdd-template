...
> **ОБЯЗАТЕЛЬНО:** Перед детальным описанием процессов сформулируй перечень сущностей Business Layer и получи подтверждение разработчика.
...
1. Проанализируй `docs/requirements/предметная область.md` (акторы, глоссарий)
2. Проанализируй `docs/requirements/домены/` (границы, ответственности)
3. Проанализируй `docs/requirements/сценарии/` (процессы, события)
