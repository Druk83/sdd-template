...
**Примечание по старым файлам:** если в репозитории есть файл `.requirements/архитектура/описание связь TL AL BL.md` — оставь минимальный каркас и ссылку на основной шаблон или удали файл; не оставляй пустые дублеры, они вводят в заблуждение агентов.
---
...
**Считать верным:**
- Есть минимум межслойных и внутрислойных связей по списку MUST.
- Связи используют типизированные ID из каталога сущностей.

**Считать неверным:**
- Связи описаны текстом без ID или без типа связи.

---

## Критерии готовности

- [ ] Заполнен минимальный набор связей (10 межслойных + 5 внутрислойных).
- [ ] Есть цепочки трассировки BL → AL → TL.
- [ ] Все связи используют ID и корректный тип отношения.
