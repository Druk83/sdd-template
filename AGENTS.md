...
| `.requirements/требования/*.md` или `FRAMEWORK_ROOT/.requirements/требования/*.md` | `docs/requirements/требования/*.md` |
| `.requirements/домены/*.md` или `FRAMEWORK_ROOT/.requirements/домены/*.md` | `docs/requirements/домены/*.md` |
| `.requirements/сценарии/*.md` или `FRAMEWORK_ROOT/.requirements/сценарии/*.md` | `docs/requirements/сценарии/<domain>/*.md` |
